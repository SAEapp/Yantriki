...
public class LBrecyclerAdapter3 extends RecyclerView.Adapter<LBrecyclerAdapter3.ViewHolder> {

    public List<LBUsers3> lbUsersList;

    public LBrecyclerAdapter3(List<LBUsers3> lbUsersList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        String Score = String.valueOf(lbUsersList.get(position).getLevel3score());
